...
SESSION_PROMPTS = {
    ...
    5: ["Prompt 5.1", "Prompt 5.2", "Prompt 5.3", "Prompt 5.4"],
    6: ["Prompt 6.1", "Prompt 6.2", "Prompt 6.3"],
    7: ["Prompt 7.1", "Prompt 7.2", "Prompt 7.3"],
    8: ["Prompt 8.1", "Prompt 8.2", "Prompt 8.3", "Prompt 8.4"],
}
...
def render_domain_glossary(terms: list[dict]):
    ...
    st.caption("Terms specific to off-price retail inventory management")
    for term in terms:
