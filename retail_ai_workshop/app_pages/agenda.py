...
AGENDA = [
    ...
    ("9:15 - 9:45 AM", "Session 1: Foundation & Reference Data", "30 min", "1"),
...
|-------------|-------|---------|
| **Tables** | ~15 | Sales transactions, inventory, customer reviews, product catalog |
| **Views** | 2+ | Feature engineering, stockout prediction features |
| **Dynamic Tables** | 1 | Live stockout risk scoring pipeline |
| **ML Models** | 2+ | Stockout classification (AutoML + notebook with XGBoost/RF/LR) |
| **Cortex Search Services** | 1 | Customer feedback knowledge base search |
| **Semantic Views** | 1 | RETAIL_OPERATIONS_VIEW with 8 tables, metrics, and AI instructions |
| **Cortex Agents** | 1 | Retail operations agent |
| **Streamlit Apps** | 1 | Retail operations dashboard |
